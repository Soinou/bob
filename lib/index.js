...
var Builder = /** @class */ (function () {
    ...
    function Builder(/* env */ _, options, target) {
        ...
        this.serving = process.argv.find(function (v) { return v.includes("webpack-dev-server"); }) != null;
        this.configuration = {
            entry: {},
            externals: {},
     ...
     */
    Builder.prototype.devServer = function (port, publicHost, publicPath) {
        this.configuration.devServer = devServer_1.devServer(port, publicHost, publicPath);
        return this;
    };
    /**
        ...
        loaders.forEach(function (loader) {
            switch (loader) {
                ...
                case "stylus":
                    ...
                    break;
                case "typescript":
                    rules.push(typescript_1.typescript(_this.parallel, loaders.includes("vue")));
     ...
     */
    Builder.prototype.analyze = function (port) {
        this.configuration.plugins.push(analyzer_1.analyzer(this.serving, port));
        return this;
    };
    /**
    ...
    Builder.prototype.build = function () {
        ...
        if (this.production) {
            ...
            this.configuration.plugins.push(new MiniCssExtractPlugin({ filename: "styles.[contenthash].css" }), new webpack.HashedModuleIdsPlugin());
        }
